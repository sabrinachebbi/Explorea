 ...
 */
final class Version20241024213845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, accommodation_pictures_id INT DEFAULT NULL, activity_pictures_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_16DB4F89C2229E86 (accommodation_pictures_id), INDEX IDX_16DB4F89B2CF3C89 (activity_pictures_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, accommodation_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, traveler_id INT DEFAULT NULL, reservation_id INT NOT NULL, note INT NOT NULL, comment LONGTEXT NOT NULL, date_re_view DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_794381C68F3692CD (accommodation_id), INDEX IDX_794381C681C06096 (activity_id), INDEX IDX_794381C659BBE8A3 (traveler_id), INDEX IDX_794381C6B83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495559BBE8A3 FOREIGN KEY (traveler_id) REFERENCES user (id)');
